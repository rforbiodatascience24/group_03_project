...
::::: columns
=======
::: r-fit-text - The PCA reduces the dimensionality of our dataset, so that we can easier group patients with similar characteristics.

::::::: r-fit-text

::: columns
>>>>>>> 190bfffe9ab662f66bb52a76ddda386e5855227c
::: {.column width="50%"}
...
::: {.column width="50%"}
![](images/06_pca_clustered-01.jpg){fig-align="center" width="1000"}
:::
<<<<<<< HEAD
:::::
::::::
