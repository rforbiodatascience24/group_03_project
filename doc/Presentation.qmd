...
-   **Purpose**:\
    A dynamic app to explore the number of hospital readmissions across various parameters in the dataset.
...
-   Which Medication had the lowest amout of readmissions in the age group (30-40\] for asians
