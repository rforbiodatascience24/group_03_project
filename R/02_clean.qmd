...
```{r}
diabetes_data_2 <- diabetes_data |> 
  mutate(admission_type_id = ifelse(admission_type_id))


#for admissiontypeid hvis admission er lig med type_id, så skriv description
```
