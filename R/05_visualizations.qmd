...
## Age diastribution, shown by race
...
data |>
  ...
  labs(
    ...
    fill = "Gender",
    title = 
      "Average number of diagnoses for all age groups and genders facet wrapped for race") +
...
data |>
  ...
  labs(title = 'Average number of diagnoses by maximum amount of visits by patient',
